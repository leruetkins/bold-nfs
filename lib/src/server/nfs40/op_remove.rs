...
impl NfsOperation for Remove4args {
    async fn execute<'a>(&self, request: NfsRequest<'a>) -> NfsOpResponse<'a> {
                debug!("Operation 28: REMOVE - Remove File System Object");
                ...
                match filehandle {
                    ...
                    Some(filehandle) => {
                        ...
                        debug!("Attempting to remove file/directory: {:?}", path);
                        ...
                        match res {
                            Ok(_) => {
                                debug!("Successfully removed file/directory");
                                NfsOpResponse {
                                    request,
                                    result: Some(NfsResOp4::Opremove(Remove4res {
                            ...
                            Err(e) => {
                                error!("Error removing file/directory: {:?}", e);
                                NfsOpResponse {
                                    request,
                                    result: None,
                                    status: e.nfs_error,
